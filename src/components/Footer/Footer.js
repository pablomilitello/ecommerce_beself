...
function Footer() {
  return (
    <footer className="footerConteiner">
      ...
      <div>
        <a href="https://instagram.com/beselfestetica.mza" className="footerText">
          <img src="../images/social/logo-instagram.svg " className="footerImgSocialNetworks" alt="logo-linkedin" />
        </a>
        <a href="https://linkedin.com" className="footerText">
          <img src=" ../images/social/logo-linkedin.svg" className="footerImgSocialNetworks" alt="logo-instagram" />
        </a>
